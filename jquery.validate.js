...
$.extend($.validator, {
	...
	prototype: {
		...
		init: function() {
			...
			$(this.currentForm)
				.validateDelegate("input:text, input:password, input:file, input[type=email], input[type=tel], input[type=number], input[type=url], input[type=date], select, textarea", "focusin focusout keyup", delegate)
